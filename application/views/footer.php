    ...
    <div class="xs-sidebar-widget">
                ...
                <ul class="sideabr-list-widget">
                    ...
                    <li>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="tel:906-624-2565">+91 7418123719</a>
		...
		<footer class="xs-footer-section footer-style4">
					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-3">
							<div class="footer-widget">
								...
								<a href="mailto:specdream.com@gmail.com" >specdream.com@gmail.com</a>
								<a href="tel:+91 7418123719">+91 7418123719</a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="copyright-section">
								<p>Copyright 2026, <a href="<?php echo base_url();?>">SpecDream Technologies</a> All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-md-6">
			...
			<div class="footer-vector-shape">
                <img src="<?php echo base_url();?>assets/images/sd/cool.svg" alt="footer vector">
            </div>
		</footer>
